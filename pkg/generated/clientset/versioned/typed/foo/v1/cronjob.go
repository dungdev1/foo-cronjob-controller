...
import (
	...
	v1 "github.com/dungdev1/foo-cronjob/pkg/apis/foo/v1"
	scheme "github.com/dungdev1/foo-cronjob/pkg/generated/clientset/versioned/scheme"
...
func newCronJobs(c *FooV1Client, namespace string) *cronJobs {
	return &cronJobs{
		client: c.RESTClient(),
		ns:     namespace,
	}
